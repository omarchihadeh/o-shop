...
const CreateProduct = () => {
    ...
    //handle submit button create product
                    ...
                    <div className='col-md-9'>
                        ...
                        <div className='m-1 w-75'>
                            ...
                            <div className='mb-3'>
                                ...
                                <div className='mb-3'>
                                    <textarea value={description} placeholder='Write a description' rows="3"
                                ...
                                <div className='mb-3'>
                                    <button className='btn btn-success' onClick={handleSubmit}>Create Product</button>
                                </div>
                            </div>
                        </div>
                    </div>
